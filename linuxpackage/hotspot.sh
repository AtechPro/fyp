...
WIFI_INTERFACE="wlan1"  # This is the interface for the hotspot
ETH_INTERFACE="eth0"    # Ethernet interface providing internet
WIFI_INTERNET_INTERFACE="wlan0"  # Wi-Fi interface providing internet
...
interface=$WIFI_INTERFACE
driver=nl80211
ssid=mqttserver    # Change this to your preferred SSID
hw_mode=g
channel=7
ieee80211n=1
wmm_enabled=1
...
# Set up NAT between the hotspot (wlan1) and internet-providing interfaces (eth0 and wlan0)
echo "Configuring NAT between $ETH_INTERFACE, $WIFI_INTERNET_INTERFACE, and $WIFI_INTERFACE..."

# Clear any existing iptables rules to prevent conflicts
sudo iptables -F
sudo iptables -t nat -F

# Configure iptables for Ethernet (eth0) - Sharing internet from eth0 to wlan1
...
# Configure iptables for Wi-Fi internet interface (wlan0) - Sharing internet from wlan0 to wlan1
